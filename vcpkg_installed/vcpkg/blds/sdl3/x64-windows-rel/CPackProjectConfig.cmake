if(CPACK_PACKAGE_FILE_NAME MATCHES ".*-src$")
    message(FATAL_ERROR "Creating source archives for SDL 3.4.16 is not supported.")
endif()

set(PROJECT_SOURCE_DIR "C:/CodeDev/Note_app/vcpkg_installed/vcpkg/blds/sdl3/src/ase-3.4.16-107b36226a.clean")
...
set(CPACK_PACKAGE_FILE_NAME "SDL3-3.4.16-${SDL_CMAKE_PLATFORM}${SDL_CPU_NAMES_WITH_DASHES}")

if(CPACK_GENERATOR STREQUAL "DragNDrop")
    set(CPACK_DMG_VOLUME_NAME "SDL3 3.4.16")
